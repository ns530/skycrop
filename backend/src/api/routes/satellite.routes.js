...
function enforceMaxBodySize(maxBytes) {
  return (req, res, next) => {
    try {
      const headerLen = req.headers['content-length']
...
// Optional: GET /api/v1/satellite/preprocess/:jobid (UUID v4 generated by crypto.randomUUID)
...
router.get(
  '/preprocess/:jobid',
  validateRequest(jobIdParams, 'params'),
  SatelliteController.getPreprocessStatus
);
