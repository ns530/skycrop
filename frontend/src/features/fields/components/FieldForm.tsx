  ...
  return (
    <Card title={title} className="max-w-xl">
      <form onSubmit={handleSubmit} className="space-y-4" noValidate>
        ...
        <div>
          <label htmlFor="field-crop-type" className="block text-sm font-medium text-gray-900">
            Crop type (optional)
          </label>
          <input
            id="field-crop-type"
        ...
        <div>
          <label htmlFor="field-notes" className="block text-sm font-medium text-gray-900">
            Notes (optional)
          </label>
          <textarea
            id="field-notes"
