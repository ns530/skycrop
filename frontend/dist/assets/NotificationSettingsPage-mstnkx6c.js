...
var v = (s, i, n) =>
    i in s
      ? T(s, i, { enumerable: !0, configurable: !0, writable: !0, value: n })
      : (s[i] = n),
  o = (s, i) => {
    for (var n in i || (i = {})) H.call(i, n) && v(s, n, i[n]);
    if (N) for (var n of N(i)) R.call(i, n) && v(s, n, i[n]);
    return s;
  },
  l = (s, i) => $(s, q(i));
var j = (s, i, n) =>
  new Promise((p, c) => {
    var h = (r) => {
      ...
      b = (r) => (r.done ? p(r.value) : Promise.resolve(r.value).then(h, d));
    b((n = n.apply(s, i)).next());
  });
import { r as g } from "./chart-vendor-C7uCl44m.js";
import { j as e } from "./feature-admin-Bw8S4RZv.js";
import { z as a, u as Y, C as x, B as w } from "./shared-B32_tFWT.js";
import "./query-vendor-B8e9_Lvn.js";
import "./router-vendor-D1DOKBjT.js";
import "./map-vendor-BIpNu-NE.js";
import "./feature-fields-fUbMVOqT.js";
import "./feature-yield-DIh4ls_q.js";
import "./http-vendor-DnTtldoj.js";
const F = () => {
  const [s, i] = g.useState(a.getPreferences()),
    [n, p] = g.useState(a.getPermission()),
    [c, h] = g.useState(!1),
    { showToast: d } = Y();
  g.useEffect(() => {
    (i(a.getPreferences()), p(a.getPermission()));
  }, []);
  const b = () =>
      j(void 0, null, function* () {
        h(!0);
        try {
          const t = yield a.requestPermission();
          (p(t),
            t === "granted"
              ? (d({
    ...
    r = () => {
      if (!s.enabled && n !== "granted") b();
      else {
        const t = l(o({}, s), { enabled: !s.enabled });
        (i(t),
          a.savePreferences(t),
          d({
            title: t.enabled
            ...
            variant: t.enabled ? "success" : "default",
          }));
      }
    },
    f = (t) => {
      const m = l(o({}, s.types), { [t]: !s.types[t] }),
        u = l(o({}, s), { types: m });
      (i(u), a.savePreferences(u));
    },
    P = () => {
      const t = l(o({}, s), { doNotDisturb: !s.doNotDisturb });
      (i(t),
        a.savePreferences(t),
        d({
    ...
    S = () => {
      const t = l(o({}, s), { soundEnabled: !s.soundEnabled });
      (i(t), a.savePreferences(t));
    },
    E = () => {
      const t = l(o({}, s), { vibrationEnabled: !s.vibrationEnabled });
      (i(t), a.savePreferences(t));
    },
    y = (t, m) => {
      const u = l(o({}, s), { [t]: m });
      ...
      !D &&
        e.jsx(x, {
          children: e.jsxs("div", {
            ...
            children: [
              e.jsx("div", { className: "text-4xl mb-3", children: "⚠️" }),
              e.jsx("p", {
                className: "text-sm font-medium text-gray-900 mb-1",
                children: "Notifications not supported",
              }),
              e.jsx("p", {
          ...
          children: [
            ...
            n === "default" &&
              ...
              e.jsx(w, {
                ...
                children: c ? "Requesting..." : "Enable Notifications",
              }),
            s.enabled &&
              e.jsx(w, {
                onClick: k,
      ...
      e.jsx(x, {
        ...
        children: e.jsxs("div", {
          ...
          children: [
            ...
            C.map(({ type: t, label: m, description: u }) =>
              e.jsxs(
                "div",
                {
              ...
              children: [
                e.jsxs("div", {
                  children: [
                    e.jsx("p", {
                      className: "text-sm font-medium text-gray-900",
                      children: "Do Not Disturb mode",
                    }),
                    e.jsx("p", {
                      className: "text-xs text-gray-600",
                      children: "Only show critical notifications",
                    }),
                  ],
                }),
                e.jsx("button", {
                    ...
                    e.jsxs("div", {
                      children: [
                        ...
                        e.jsx("input", {
                          ...
                          onChange: (t) => y("quietHoursStart", t.target.value),
                          disabled: !s.enabled,
                          className:
                            "w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-brand-blue focus:outline-none focus:ring-1 focus:ring-brand-blue disabled:opacity-50",
                        }),
                      ],
                    }),
                    e.jsxs("div", {
                      children: [
                        ...
                        e.jsx("input", {
                          type: "time",
                          value: s.quietHoursEnd || "07:00",
                          onChange: (t) => y("quietHoursEnd", t.target.value),
                          disabled: !s.enabled,
                          className:
                            "w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-brand-blue focus:outline-none focus:ring-1 focus:ring-brand-blue disabled:opacity-50",
                        }),
              ...
              children: [
                e.jsxs("div", {
                  children: [
                    ...
                    e.jsx("p", {
                      className: "text-xs text-gray-600",
                      children: "Play sound with notifications",
                    }),
                  ],
                }),
                e.jsx("button", {
              ...
              children: [
                e.jsxs("div", {
                  children: [
                    ...
                    e.jsx("p", {
                      className: "text-xs text-gray-600",
                      children: "Vibrate on mobile devices",
                    }),
                  ],
                }),
                e.jsx("button", {
